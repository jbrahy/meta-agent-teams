# Customer-success-team Agent Team

This team helps run Customer Success Team workflows with clear planning, coordination, diagnostics, and continuous improvement.
...
../../bin/run-agent.sh customer-success-team execution-support
...
../../bin/run-cycle.sh customer-success-team
```
