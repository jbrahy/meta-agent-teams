# Red-team-team Agent Team

This team helps manage Red Team Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh red-team-team execution-support
...
../../bin/run-cycle.sh red-team-team
```
