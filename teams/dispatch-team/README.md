# Dispatch-team Agent Team

This team helps manage Dispatch Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh dispatch-team execution-support
...
../../bin/run-cycle.sh dispatch-team
```
