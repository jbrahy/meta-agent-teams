# Podcast-production-team Agent Team

This team helps manage Podcast Production Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh podcast-production-team execution-support
...
../../bin/run-cycle.sh podcast-production-team
```
