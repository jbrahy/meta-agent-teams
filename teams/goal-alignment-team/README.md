# Goal-alignment-team Agent Team

This team helps manage Goal Alignment Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh goal-alignment-team execution-support
...
../../bin/run-cycle.sh goal-alignment-team
```
