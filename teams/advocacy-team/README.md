# Advocacy-team Agent Team

This team helps manage Advocacy Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh advocacy-team execution-support
...
../../bin/run-cycle.sh advocacy-team
```
