# Meeting-prep-team Agent Team

This team helps run Meeting Prep Team workflows with clear planning, coordination, diagnostics, and continuous improvement.
...
../../bin/run-agent.sh meeting-prep-team execution-support
...
../../bin/run-cycle.sh meeting-prep-team
```
