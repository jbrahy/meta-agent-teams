# Leverage-finder-team Agent Team

This team helps manage Leverage Finder Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh leverage-finder-team execution-support
...
../../bin/run-cycle.sh leverage-finder-team
```
