# Idea-capture-team Agent Team

This team helps manage Idea Capture Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh idea-capture-team execution-support
...
../../bin/run-cycle.sh idea-capture-team
```
