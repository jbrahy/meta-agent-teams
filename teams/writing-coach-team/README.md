# Writing-coach-team Agent Team

This team helps manage Writing Coach Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh writing-coach-team execution-support
...
../../bin/run-cycle.sh writing-coach-team
```
