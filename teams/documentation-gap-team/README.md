# Documentation-gap-team Agent Team

This team helps manage Documentation Gap Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh documentation-gap-team execution-support
...
../../bin/run-cycle.sh documentation-gap-team
```
