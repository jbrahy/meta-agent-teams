# Crm-marketing-team Agent Team

This team helps produce, refine, and evaluate CRM Marketing Team initiatives using coordinated specialist agents.
...
../../bin/run-agent.sh crm-marketing-team audience-and-insight-research
...
../../bin/run-cycle.sh crm-marketing-team
```
