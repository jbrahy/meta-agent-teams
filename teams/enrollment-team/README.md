# Enrollment-team Agent Team

This team helps manage Enrollment Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh enrollment-team execution-support
...
../../bin/run-cycle.sh enrollment-team
```
