# Legal-operations Agent Team

This team helps run Legal Operations workflows with clear planning, coordination, diagnostics, and continuous improvement.
...
../../bin/run-agent.sh legal-operations execution-support
...
../../bin/run-cycle.sh legal-operations
```
