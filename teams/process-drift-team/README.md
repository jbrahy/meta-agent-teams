# Process-drift-team Agent Team

This team helps manage Process Drift Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh process-drift-team execution-support
...
../../bin/run-cycle.sh process-drift-team
```
