# Decision-journal-team Agent Team

This team helps manage Decision Journal Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh decision-journal-team execution-support
...
../../bin/run-cycle.sh decision-journal-team
```
