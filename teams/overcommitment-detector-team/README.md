# Overcommitment-detector-team Agent Team

This team helps manage Overcommitment Detector Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh overcommitment-detector-team execution-support
...
../../bin/run-cycle.sh overcommitment-detector-team
```
