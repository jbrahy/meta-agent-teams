# Program-management Agent Team

This team helps run Program Management workflows with clear planning, coordination, diagnostics, and continuous improvement.
...
../../bin/run-agent.sh program-management execution-support
...
../../bin/run-cycle.sh program-management
```
