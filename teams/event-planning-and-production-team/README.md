# Event-planning-and-production-team Agent Team

This team helps manage Event Planning And Production Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh event-planning-and-production-team execution-support
...
../../bin/run-cycle.sh event-planning-and-production-team
```
