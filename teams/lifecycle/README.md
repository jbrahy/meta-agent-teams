# Lifecycle Agent Team

This team helps manage Lifecycle work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh lifecycle execution-support
