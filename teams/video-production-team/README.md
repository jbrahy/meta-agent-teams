# Video-production-team Agent Team

This team helps manage Video Production Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh video-production-team execution-support
...
../../bin/run-cycle.sh video-production-team
```
