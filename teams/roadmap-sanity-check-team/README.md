# Roadmap-sanity-check-team Agent Team

This team helps manage Roadmap Sanity Check Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh roadmap-sanity-check-team execution-support
...
../../bin/run-cycle.sh roadmap-sanity-check-team
```
