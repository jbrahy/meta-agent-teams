# Slack-pattern-team Agent Team

This team helps manage Slack Pattern Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh slack-pattern-team execution-support
...
../../bin/run-cycle.sh slack-pattern-team
```
