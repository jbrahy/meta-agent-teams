# Workflow-simplification-team Agent Team

This team helps run Workflow Simplification Team workflows with clear planning, coordination, diagnostics, and continuous improvement.
...
../../bin/run-agent.sh workflow-simplification-team execution-support
...
../../bin/run-cycle.sh workflow-simplification-team
```
