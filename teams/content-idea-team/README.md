# Content-idea-team Agent Team

This team helps produce, refine, and evaluate Content Idea Team initiatives using coordinated specialist agents.
...
../../bin/run-agent.sh content-idea-team audience-and-insight-research
...
../../bin/run-cycle.sh content-idea-team
```
