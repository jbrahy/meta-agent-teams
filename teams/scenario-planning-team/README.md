# Scenario-planning-team Agent Team

This team helps manage Scenario Planning Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh scenario-planning-team execution-support
...
../../bin/run-cycle.sh scenario-planning-team
```
