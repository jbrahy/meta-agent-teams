# Ai-evaluation Agent Team

This team helps manage AI Evaluation work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh ai-evaluation execution-support
...
../../bin/run-cycle.sh ai-evaluation
```
