# Chief-of-staff Agent Team

This team helps manage Chief Of Staff work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh chief-of-staff execution-support
...
../../bin/run-cycle.sh chief-of-staff
```
