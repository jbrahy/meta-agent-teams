# Product-feedback-team Agent Team

This team helps manage Product Feedback Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh product-feedback-team execution-support
...
../../bin/run-cycle.sh product-feedback-team
```
