# Customer-signal-team Agent Team

This team helps run Customer Signal Team workflows with clear planning, coordination, diagnostics, and continuous improvement.
...
../../bin/run-agent.sh customer-signal-team execution-support
...
../../bin/run-cycle.sh customer-signal-team
```
