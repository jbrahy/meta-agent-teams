# Contracts-team Agent Team

This team helps analyze Contracts Team work carefully with strong guardrails, review steps, and documentation.
...
../../bin/run-agent.sh contracts-team documentation-and-communication-support
...
../../bin/run-cycle.sh contracts-team
```
