# Product-discovery-team Agent Team

This team helps manage Product Discovery Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh product-discovery-team execution-support
...
../../bin/run-cycle.sh product-discovery-team
```
