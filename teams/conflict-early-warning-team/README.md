# Conflict-early-warning-team Agent Team

This team helps manage Conflict Early Warning Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh conflict-early-warning-team execution-support
...
../../bin/run-cycle.sh conflict-early-warning-team
```
