# Travel-planning Agent Team

This team helps manage Travel Planning work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh travel-planning execution-support
...
../../bin/run-cycle.sh travel-planning
```
