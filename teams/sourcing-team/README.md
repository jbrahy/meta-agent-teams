# Sourcing-team Agent Team

This team helps manage Sourcing Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh sourcing-team execution-support
...
../../bin/run-cycle.sh sourcing-team
```
