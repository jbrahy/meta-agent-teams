# Offer-refinement-team Agent Team

This team helps manage Offer Refinement Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh offer-refinement-team execution-support
...
../../bin/run-cycle.sh offer-refinement-team
```
