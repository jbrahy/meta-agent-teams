# Admissions Agent Team

This team helps manage Admissions work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh admissions execution-support
