# Inbox-advisory-team Agent Team

This team helps manage Inbox Advisory Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh inbox-advisory-team execution-support
...
../../bin/run-cycle.sh inbox-advisory-team
```
