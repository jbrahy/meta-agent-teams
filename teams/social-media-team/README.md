# Social-media-team Agent Team

This team helps produce, refine, and evaluate Social Media Team initiatives using coordinated specialist agents.
...
../../bin/run-agent.sh social-media-team audience-and-insight-research
...
../../bin/run-cycle.sh social-media-team
```
