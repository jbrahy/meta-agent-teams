# Localization Agent Team

This team helps manage Localization work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh localization execution-support
