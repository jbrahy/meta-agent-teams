# Game-design Agent Team

This team helps manage Game Design work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh game-design execution-support
