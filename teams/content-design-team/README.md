# Content-design-team Agent Team

This team helps produce, refine, and evaluate Content Design Team initiatives using coordinated specialist agents.
...
../../bin/run-agent.sh content-design-team audience-and-insight-research
...
../../bin/run-cycle.sh content-design-team
```
