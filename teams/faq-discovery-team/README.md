# Faq-discovery-team Agent Team

This team helps manage Faq Discovery Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh faq-discovery-team execution-support
...
../../bin/run-cycle.sh faq-discovery-team
```
