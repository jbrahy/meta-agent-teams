...
This team helps manage Incident Response work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh incident-response execution-support
...
../../bin/run-cycle.sh incident-response
```
