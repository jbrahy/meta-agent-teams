# Task-triage-team Agent Team

This team helps manage Task Triage Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh task-triage-team execution-support
...
../../bin/run-cycle.sh task-triage-team
```
