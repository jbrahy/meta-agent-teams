# Bottleneck-finder-team Agent Team

This team helps manage Bottleneck Finder Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh bottleneck-finder-team execution-support
...
../../bin/run-cycle.sh bottleneck-finder-team
```
