# Public-affairs Agent Team

This team helps analyze Public Affairs work carefully with strong guardrails, review steps, and documentation.
...
../../bin/run-agent.sh public-affairs documentation-and-communication-support
...
../../bin/run-cycle.sh public-affairs
```
