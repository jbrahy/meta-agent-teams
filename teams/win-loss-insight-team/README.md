# Win-loss-insight-team Agent Team

This team helps manage Win Loss Insight Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh win-loss-insight-team execution-support
...
../../bin/run-cycle.sh win-loss-insight-team
```
