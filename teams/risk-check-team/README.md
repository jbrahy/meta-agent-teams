# Risk-check-team Agent Team

This team helps analyze Risk Check Team work carefully with strong guardrails, review steps, and documentation.
...
../../bin/run-agent.sh risk-check-team documentation-and-communication-support
...
../../bin/run-cycle.sh risk-check-team
```
