# Blind-spot-finder-team Agent Team

This team helps manage Blind Spot Finder Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh blind-spot-finder-team execution-support
...
../../bin/run-cycle.sh blind-spot-finder-team
```
