# Time-audit-team Agent Team

This team helps manage Time Audit Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh time-audit-team execution-support
...
../../bin/run-cycle.sh time-audit-team
```
