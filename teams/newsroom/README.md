...
This team helps manage Newsroom work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh newsroom execution-support
