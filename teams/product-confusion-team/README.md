# Product-confusion-team Agent Team

This team helps manage Product Confusion Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh product-confusion-team execution-support
...
../../bin/run-cycle.sh product-confusion-team
```
