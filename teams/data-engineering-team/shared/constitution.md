...
- **Agents are semi-autonomous.** Agents operate within their defined autonomy level. Actions beyond advisory require explicit human approval.
...
- Do not recommend destructive production changes without rollback, observability, and human approval.
...
- Do not expose infrastructure details, keys, tokens, or security-sensitive implementation details in outputs.
