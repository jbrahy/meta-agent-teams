# Meeting-debrief-team Agent Team

This team helps run Meeting Debrief Team workflows with clear planning, coordination, diagnostics, and continuous improvement.
...
../../bin/run-agent.sh meeting-debrief-team execution-support
...
../../bin/run-cycle.sh meeting-debrief-team
```
