# Tradeoff-advisor-team Agent Team

This team helps manage Tradeoff Advisor Team work with specialist agents that research, plan, review, and improve outcomes.
...
../../bin/run-agent.sh tradeoff-advisor-team execution-support
...
../../bin/run-cycle.sh tradeoff-advisor-team
```
