# Content-gap-team Agent Team

This team helps produce, refine, and evaluate Content Gap Team initiatives using coordinated specialist agents.
...
../../bin/run-agent.sh content-gap-team audience-and-insight-research
...
../../bin/run-cycle.sh content-gap-team
```
